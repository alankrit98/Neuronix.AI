  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
        <div className='text-center'>
            ...
            <p className='text-gray-500 max-w-lg mx-auto'>Empower your content creation journey with cutting-edge AI technologies designed to simplify tasks and bring your ideas to life faster</p>
        </div>
